---
title: "Intro to listviewer"
author: "Kent Russell"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Intro to listviewer}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

- copied from [timelyportfolio/listviewer](https://raw.githubusercontent.com/timelyportfolio/listviewer/master/README.md)
...
## save(afghanmap, file = "../data/afghanmap.rda")
## devtools::document()
## devtools::install()

data(afghanmap, package = "rcw")
afghanmap %>>%
  jsonedit
```
